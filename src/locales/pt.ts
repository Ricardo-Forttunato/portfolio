const pt = {
  ...
  home: {
    ...
    title: 'Interfaces que transformam ideias em produtos claros, rapidos e escalaveis.',
    description:
  ...
  about: {
    kicker: 'Sobre mim',
    title: 'Construo produtos com equilibrio entre detalhe visual e solidez tecnica.',
    paragraph1:
  ...
  contact: {
    ...
    alerts: {
      envMissing: 'Configure as variaveis VITE_EMAILJS_* para habilitar o envio.',
